...
@Ruilong Li: This file is hacked based on:
https://github.com/pytorch/pytorch/blob/4a37f57c69b5c3f4b8342cbff0f51cb6cd26b4e1/torch/utils/data/dataloader.py#L124

Tested against torch==2.1.0
"""
...
class _MultiProcessingDataLoaderIter(_BaseDataLoaderIter):
    ...
    def __init__(self, loader):
        ...
        if self._pin_memory:
            ...
            self._pin_memory_result_queue = queue.Queue()  # type: ignore[var-annotated]
            ...
            self._pin_memory_result_queue = self._worker_result_queue  # type: ignore[assignment]
